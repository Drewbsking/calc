...
MARKER = "TS "  # Original presets: "TS ", "63", or " P ".
RECURSIVE = False
EXTENSIONS = ()
# =====================================================
...
def validate_settings():
    if not MARKER or not MARKER.strip():
        raise ValueError("Set MARKER to the text to keep from.")
