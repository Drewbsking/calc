r"""Append a Filename Suffix.

Originally used for Traffic Control Order (TCO) file cleanup.
Selected folder only. Set SUFFIX for the current job. Names already ending in that exact suffix are skipped.
Run: py .\append_filename_suffix.py
"""
...
SUFFIX = "-NTORH"  # Text to add before the file extension.
RECURSIVE = False
EXTENSIONS = ()
# =====================================================
...
def validate_settings():
    if not SUFFIX:
        raise ValueError("Set SUFFIX to the text to append.")
