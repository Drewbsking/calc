function calculateLOS() {
    ...
    const obsFreeFlowSpeed = parseFloat(document.getElementById('obsFreeFlowSpeed').value);
...
function getLOS(density, obsFreeFlowSpeed) {
    for (const entry of losTable) {
        if ((entry.FFS === 'All' || entry.FFS == obsFreeFlowSpeed) &&
